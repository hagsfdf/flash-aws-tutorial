...
CLOUDSQL_CONNECTION_NAME = 'ee488g-20160258:asia-east1:hw3'
...
LOCAL_SQLALCHEMY_DATABASE_URI = (
    'mysql+pymysql://{user}:{password}@{endpoint}/{database}').format(
        user=CLOUDSQL_USER, password=CLOUDSQL_PASSWORD, endpoint=AWS_ENDPOINT,
...
LIVE_SQLALCHEMY_DATABASE_URI = LOCAL_SQLALCHEMY_DATABASE_URI
